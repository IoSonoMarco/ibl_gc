functions {
  ...
  vector response_model(vector m, real zeta, real lapse) {
...
transformed parameters {
  ...
  p_choice = response_model(x_1_expected_mean, zeta, lapse);
}
...
model {
  ...
  target += std_normal_lpdf(zeta_latent);
